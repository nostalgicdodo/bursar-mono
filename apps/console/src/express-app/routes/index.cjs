...
const { isProduction, exceptionMailer, getRedisClient, getAppName, getRedisSecret } = require('@root/server/index.cjs');
...
router.use('/api', require('./api/index.cjs'));
router.use('/_d', require('@routes/diagnostics/index.cjs'));
router.use('/auth', require('./authentication/index.cjs'));

// router.use(require('./remix/index.cjs'));
