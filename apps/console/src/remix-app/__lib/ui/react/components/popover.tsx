...
function usePopoverContext () {
	...
	if ( context == null ) {
		throw new Error( "Popover components must be wrapped within a <Popover />" )
	}
...
Popover.Content = React.forwardRef<
	HTMLDivElement,
	{ onClose: () => void } & React.HTMLProps<HTMLDivElement>
>( function PopoverContent ( { className, onClose = noOp, ...props }, propRef ) {
	const { context: floatingContext, ...context } = usePopoverContext()
	const ref = useMergeRefs( [ context.refs.setFloating, propRef ] )
	const wasPreviouslyOpen = usePreviousValue( floatingContext.open )
...
Popover.Close = React.forwardRef<
	HTMLButtonElement,
...
Popover.Heading = React.forwardRef<
	HTMLHeadingElement,
...
Popover.Description = React.forwardRef<
