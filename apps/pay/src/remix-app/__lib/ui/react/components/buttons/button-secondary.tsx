...
export default function ButtonSecondary ( { size = "regular", as = "button", className = "", removeClasses = [ ], submitting = false, children, ...props }: Partial<ButtonProps> ) {
	...
	const fullClassName = `relative ${ baseClasses } rounded-25 font-bold uppercase text-black outline-none button-shadow text-center ${ sizes[ size ] } ${ textCases[ textCase ] } ${ submittingClassName }`
